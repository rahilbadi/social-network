    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open"> <a href="{{ route('profile.index') }}" class="nav-link active"> <i
                ...
                <li class="nav-item menu-open"> <a href="{{ route('post.index') }}" class="nav-link active"> <i
                            class="fas fa-plus"></i>
                        <p>
                            Post
                        </p>
